...
nw.dup_net6(model_from, model, 'model.conv1', 'model.bn1', 'xx','xx', 'model.fc', 'classifier') #C1+FC remain
...
optimizer_ft = optim.SGD([
    ...
    {'params': model.model.layer1.parameters(), 'lr': 0.01},
    {'params': model.model.layer2.parameters(), 'lr': 0.01},
